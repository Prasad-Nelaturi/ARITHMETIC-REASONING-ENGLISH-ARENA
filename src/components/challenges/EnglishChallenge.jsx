...
import { BookOpen, CheckCircle2, XCircle, Lightbulb, Loader2, AlertCircle, RefreshCw } from 'lucide-react'
...
const EnglishChallenge = ({
    ...
    useEffect(() => {
        ...
        setQuestions(null)
        setLoadError(null)
        fetchQuestionSet('english', level, QUESTIONS_PER_ROUND)
    ...
    if (!questions) {
        return (
            <div className="flex flex-col items-center gap-3 py-10 px-5">
                <Loader2 size={28} className="animate-spin text-blue-300" strokeWidth={2.6} />
    ...
    return (
        <div className="flex flex-col items-center gap-3 w-full">
            ...
            <div className="inline-flex items-center gap-1.5 text-[10px] font-black tracking-[1.4px] uppercase text-blue-300 bg-blue-500/15 border border-blue-500/35 px-2.5 py-1 rounded-full">
